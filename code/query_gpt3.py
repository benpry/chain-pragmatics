...
if __name__ == "__main__":
    ...
    for item in relevant_corpus:
        ...
        rationale_prompt = make_rationale_prompt(item["prompt"], "comparison")
    ...
    with open(here(f"data/model-outputs/gpt3_metaphor_multiplechoice_davinci_5shot_comparison.p"), "wb") as fp:
